                    ...
                    <div className="container mx-auto sm:h-[550px] sm:py-0 py-5">
                        <div className="flex flex-col justify-center items-center h-full">
                            <div className="sm:w-1/2">
                                ...
                                <p className="text-lg my-5 px-5 mx-auto text-center sm:text-left">Learn English with our effective methodology</p>
                    ...
                    <div className="container mx-auto sm:h-[550px] sm:py-0 py-5">
                        <div className="flex flex-col justify-center items-center h-full">
                            <div className="sm:w-1/2">
                                ...
                                <p className="text-lg my-5 px-5 mx-auto">Our language programs at SUMMER TIME CAMPS have been attracting the attention of children and parents for over 29 years.</p>
